...
const autocomplete = new ui.autocomplete.uiClass("autocomplete" ,"200px","")

const checkbox1 = new ui.checkbox.uiClass("checkbox1", true, "Checkbox 1", "cross")
const checkbox2 = new ui.checkbox.uiClass("checkbox2", false, "Checkbox 2", "tick")

const radiobuttonGroup = new ui.radiobuttonGroup.uiClass("radiobuttonGroup",null)

const dropdown = new ui.dropdown.uiClass("dropdown", "Please select", "200px")

const checkedDropdown = new ui.checkedDropdown.uiClass("checkedDropdown", "200px")
